...
const CACHE_NAME = 'bible-multi-v88';   /* v88(0810):註釋內 SNG/SNH 原文編號就地展開中文字義(sd.php+LS快取) */   /* v79(0802):右下角 ⬆ 回頂鈕(長章 60 節×5 譯本滑回分頁太久);v78=複製鈕去圖示 */   /* v76(0802):收回線上失散的 0724-25 停留三件(last=/一發搞定/25s心跳)+ 複製鈕改名 + 標題列單行 + 經文貼邊。
